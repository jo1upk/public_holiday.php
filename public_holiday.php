...
class public_holiday_jp extends public_holiday
{
	...
	var $tbl_SpecificDay = array(
		...
		array( 2,23, 20200101, 99999999,'天皇誕生日'),			// 令和天皇
		...
		array( 4,29, 19480720, 19890216,'天皇誕生日'),			// 昭和天皇
		array( 4,29, 19890217, 20061231,'みどりの日'),
		array( 4,29, 20070101, 99999999,'昭和の日'),
		array( 5, 1, 20181214, 20191231,'天皇の即位の日'),		// 平成30年法律第99号
		...
		array( 7,23, 20200101, 20201231,'海の日'),			// 平成30年法律第55号
		array( 7,24, 20200101, 20201231,'スポーツの日'),		// 平成30年法律第55号
		array( 7,30, 19120903, 19270302,'明治天皇祭'),
		array( 8,10, 20200101, 20201231,'山の日'),			// 平成30年法律第55号
		array( 8,11, 20160101, 20191231,'山の日'),			// 平成26年法律第43号
		array( 8,11, 20210101, 99999999,'山の日'),			// 平成26年法律第43号
		...
		array(12,23, 19890217, 20190430,'天皇誕生日'),			// 平成天皇
	...
	var $tbl_HappyMonday = array(
		...
		array( 7, 3,   1, 20030101, 20191231, '海の日'),		// 平成30年法律第55号
		array( 7, 3,   1, 20210101, 99999999, '海の日'),		// 平成30年法律第55号
		array( 9, 3,   1, 20030101, 99999999, '敬老の日'),
		array(10, 2,   1, 20000101, 20191231, '体育の日'),		// 平成30年法律第55号
		array(10, 2,   1, 20210101, 99999999, 'スポーツの日'),		// 平成30年法律第57号
